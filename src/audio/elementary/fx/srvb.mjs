/*
 * Источник: https://github.com/chromatone/elements — elements/fx/srvb.js
 * Автор: Денис Старов (Chromatone), MIT License, Copyright (c) 2024 Chromatone.
 * Перенесено в Biotron 04.09.2026 с разрешения автора: синт сделан им в поддержку этого проекта.
 * Изменения при переносе: убран импорт Vue-обвязки; в остальном математика не тронута —
 * сеть обратных связей с матрицей Адамара 8x8 выведена и настроена автором вручную.
 */
