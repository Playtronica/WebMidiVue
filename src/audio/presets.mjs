...
export function validatePreset(input = {}) {
  return Object.freeze({
    ...
    clearUpTo: clamp(input.clearUpTo, 0, 40, 0)
  })
}
...
const rawGlassFlutes = [
  ...
  {name:'Singing Glass',waveA:'sine',waveB:'triangle',detune:5,mixB:.16,attack:.09,release:.62,cutoff:6900,resonance:.9,pitchStartCents:-55,pitchGlideSeconds:.18,vibratoRate:6.4,vibratoDepth:18,delayTime:.21,delayFeedback:.09,delayWet:.05,reverbWet:.15,clearUpTo:1},
